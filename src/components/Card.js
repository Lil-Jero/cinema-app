...
const Card = ({ movie }) => {
    ...
    return (
        <div className="card">
            ...
            {movie.release_date ? <h5>Sortie le: {dateFormater(movie.release_date)}</h5> : null}
            ...
            <p>{movie.overview}</p>
            {movie.genre_ids ? (<div className="btn" onClick={() => addStorage()}>Ajouter aux coups de coeurs </div>)
